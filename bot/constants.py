...
ABOUT_MESSAGE = """what can do this bot? 
...
SETTINGS_MESSAGE = """Выбери, что хочешь изменить: """ #кнопки имя / факультет / степень обучения / добавить интерес / удалить интерес / exit
...
NEW_QUESTION_PROBLEM_MESSAGE = """Введи вопрос. Не задавай вопросов, которые допускают спорные или субъективные ответы, а также вопросов, которые могут привести к обсуждению (для таких вопросов создай обуждение)""" #кнопка exit
...
NEW_QUESTION_THEME_SAVED_MESSAGE = """Тема успешно сохранена. Чтобы добавить ещё одну тему, используй кнопку /add. Чтобы завершить выбор тем, используй кнопку /finish""" #кнопки / add / finish / exit 
NEW_QUESTION_THEME_FINISH_MESSAGE = """Процесс выбора тем завершён""" #кнопка exit
NEW_QUESTION_ANONIM_MESSAGE = """Хочешь задать вопрос анонимно?""" #кнопки да, нет, exit
NEW_QUESTION_END_MESSAGE = """Вопрос сохранён и отправлен на модерацию. По итогам проверки тебе придёт сообщение с результатом. ID вопроса: {{id}}"""
NEW_DISCUSSION_MESSAGE = """Сформулируй название обсуждения. Будь конкретен""" #кнопка exit
NEW_DISCUSSION_PROBLEM_MESSAGE = """Опиши проблему, которую хочешь вынести на обсуждение. Спрашивай о реальной проблеме, с которой столкнулся. Подробно опиши, чего хочешь добиться, что уже сделал и что предлагаешь обсудить""" #кнопка exit
