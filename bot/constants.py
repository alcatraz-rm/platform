...
# кнопка start
ABOUT_MESSAGE = '''Я - бот студентов МехМата! Нахожу и объединяю людей по учебным вопросам. Создав аккаунт, задавай свои вопросы или создавай обсуждения, чтобы разобраться в проблеме, а я постараюсь найти заинтересованных людей.  

Бот может решать твои проблемы через вопросы и обсуждения.
Создавай вопрос, если нужен ответ на один конкретный вопрос. Получив ответ, который тебе помог, закрой вопрос.
Создавай обсуждение, если вопросов по одной теме много и они требуют дискуссию. Или создавай обсуждение, когда нужно найти людей для совместной учебы.
