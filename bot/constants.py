...
# SETTINGS_SENTENCES:
    ...
    SETTINGS_DEGREE_MESSAGE = """Введи свою степень обучения: """ //кнопка exit// """Твоя степень обучения изменена на {{degree}}""" 
    SETTINGS_DELETE_MESSAGE = """Выбери интерес, который хочешь удалить: {{list of interests}}""" //кнопка exit// """Интерес {{interest}} удалён"""
    SETTINGS_ADD_MESSAGE = """Выбери науку {{list of sciences}}""" //кнопка exit// """Выбери дисциплину {{list of disciplines}}""" //кнопка exit, skip// """Выбери раздел {{list of sections}}""" //кнопка exit, skip// """Интерес {{interest}} добавлен"""
...
"""Выбери не более 3 тем для совего вопроса""" //кнопка exit// """Выбери науку {{list of sciences}}""" //кнопка exit// """Выбери дисциплину {{list of disciplines}}""" //кнопка exit, skip// """Выбери раздел {{list of sections}}""" //кнопка exit, skip// 
"""Тема успешно сохранена. Чтобы добавить ещё одну тему, используй кнопку /add. Чтобы завершить выбор тем, используй кнопку /finish""" //кнопки , add, finish, exit// """Процесс выбора тем завершён""" //кнопка exit//  """Хочешь задать вопрос анонимно?""" //кнопки да, нет, exit//
"""Вопрос сохранён и отправлен на модерацию. По итогам проверки тебе придёт сообщение с результатом. ID вопроса: {{id}}"""
    NEW_DISCUSSION_MESSAGE = """Сформулируй название обсуждения. Будь конкретен""" //кнопка exit// """Опиши проблему, которую хочешь вынести на обсуждение. Спрашивай о реальной проблеме, с которой столкнулся. Подробно опиши, чего хочешь добиться, что уже сделал и что предлагаешь обсудить""" //кнопка exit// 
"""Выбери не более 5 тем для совего вопроса""" //кнопка exit// """Выбери науку {{list of sciences}}""" //кнопка exit// """Выбери дисциплину {{list of disciplines}}""" //кнопка exit, skip// """Выбери раздел {{list of sections}}""" //кнопка exit, skip// 
"""Тема успешно сохранена. Чтобы добавить ещё одну тему, используй кнопку /add. Чтобы завершить выбор тем, используй кнопку /finish""" //кнопки , add, finish, exit// """Процесс выбора тем завершён""" //кнопка exit//
"""Обсуждение сохранёно и отправлено на модерацию. По итогам проверки тебе придёт сообщение с результатом. ID обсуждения: {{id}}"""
